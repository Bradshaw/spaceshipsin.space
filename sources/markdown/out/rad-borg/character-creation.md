...
For each score, roll 4d6 and drop the lowest, get the final score from this table:
- 1-4: -3
- 5-6: -2
- 7-8: -1
- 9-12: ±0
...
- 2d6 × 10 Bits
- Choose:
   - Thermos with four days of drinking water
   - d4 spare parts
- Choose:
   - d4 snacks
   - d4 batteries

### Bag (d4 or one of the above)
1. Satchel
2. Backpack
3. Duffel bag
4. Satchel and a backpack

### Wheels (d4 or one of the above)
1. No wheels, just a sweet pair of shoes
2. Roller shoes
3. Skateboard
4. BMX

### Adventurer Stuff (d12)
1. Rope 10 metres
